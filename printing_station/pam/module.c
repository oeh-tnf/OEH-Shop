...
bool
auth_user(const char*, const char*);
void
change_pass(const char*, const char*);
/**
 * @brief R
 *
 * @param user
 ...
 */
bool
auth_user(const char* user, const char* password)
{
...
void
change_pass(const char* username, const char* password)
{
...
pam_sm_chauthtok(pam_handle_t* pamh, int flags, int argc, const char** argv)
{
  ...
  if((flags & PAM_UPDATE_AUTHTOK) || (flags & PAM_CHANGE_EXPIRED_AUTHTOK)) {
     ...
     * PAM_OLDAUTHTOK. */
    pam_get_authtok(
      pamh, PAM_OLDAUTHTOK, &cur_password, "Insert current password: ");
